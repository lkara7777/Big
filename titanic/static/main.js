...
function buttonDetails() {
  alert("Write how many times you have given a test of this type of product, fulfil a number please.");
}
function buttonDetails1() {
  alert("Write how many times you have given a test with us, fulfil a number please.");
}
